export const person = {
  ...
  location: "New York",
 /** One-line path for hero presence - employers only, no invented titles. */
  careerLine: "Quantile (LSEG) · OpenGamma · Wells Fargo",
...
/**
 * Homepage featured systems - complementary strengths for a 60-second skim.
 * Full ledger remains on /work. Order: production AI (ops + incident) →
 * market infrastructure → independent products.
 */
...
export const metrics = [
  ...
  { value: "$6.5T", label: "eligible notional unlocked", href: "/work/cross-currency" },
];
...
export const cases: CaseStudy[] = [
  {
    ...
    featured: true,
    summary:
 "A production AI agent inside a live operations workflow, not a side chatbot. Bounded actions, operator visibility, and a quality bar the system had to hold.",
  ...
  },
  {
    ...
    featured: true,
    summary:
      "When something broke in production, ops still paged senior engineers by default. CoCo gathers domain evidence first, sharpens the diagnosis, and escalates only when the packet is incomplete.",
    ...
    blocks: [
      {
        title: "What I owned",
        body: [
 "Framed the product as diagnosis, not chat - success meant fewer eng pages, not more answers",
          "Defined the two MCP domain boundaries and the escalation rule when evidence is incomplete",
          "Tied launch criteria to investigation time and escalation rate in production",
        ],
      },
      {
        title: "System pattern",
  ...
  },
  {
    ...
    featured: true,
    summary:
 "Banks held huge cross-currency books that could only net in pairs. A new settlement path made network-wide offsets executable - so previously stuck notional could finally compress.",
    ...
    blocks: [
      {
        ...
        body: [
          "Banks hold large cross-currency positions. Pairwise netting left network-wide offsets stuck",
 "Eligible notional means exposure that became eligible to enter the compression run - not revenue, AUM, or cash saved",
          ...
          "Success was measured as notional made eligible and notional reduced per run, with risk intent held inside constraints",
        ],
      },
      {
        title: "What I owned",
        body: [
          "Owned the 0→1 launch: product design, eligibility rules, workflow, institutional onboarding, and GTM",
 "Treated settlement design as part of the product - a mathematically good offset is worthless if it cannot clear",
          "Kept the risk envelope explicit so compression did not silently change the book’s intent",
        ],
      },
      {
        title: "How it works",
  ...
  },
  {
    ...
    stage: "0→1 launch",
    summary:
 "A late valuation mismatch can halt a multi-trillion compression cycle. An independent view plus a tolerance check moved failure upstream - while it was still cheap to fix.",
    ...
    blocks: [
      {
        title: "In plain terms",
        body: [
          "Compression cycles only run if valuations agree. A late mismatch stops the room",
 ...
 "Success was earlier detection and fewer expensive resubmissions - not a pricing product",
        ],
      },
      {
        title: "What I owned",
        body: [
          "Defined the product strategy: data quality as a control before live, not an ops cleanup",
          "Launched the dual-source valuation and validation engine for institutional cycles",
          "Tied success to detection lead time and resubmission rate across participating banks",
        ],
      },
      {
        title: "How it works",
  ...
  },
  {
    ...
    stage: "Production",
    summary:
 "A mathematically good FX proposal still fails if margin or data disagree. Margin checks and four-source validation had to live inside the optimizer - before the live window.",
    ...
    blocks: [
      {
        title: "In plain terms",
        body: [
          "FX forwards and NDFs (non-deliverable forwards) only compress if the proposal can clear margin and data checks",
 ...
 "Success was proposal acceptance and fewer live failures - measured across 40+ runs",
        ],
      },
      {
        title: "What I owned",
        body: [
          "Designed and shipped FX-forward and NDF compression with margin intelligence in the product",
          "Embedded the ForexClear margin API in the optimizer rather than validating after the fact",
          "Added four-source validation as a pre-live gate and tied launch to acceptance and reliability",
        ],
      },
      {
        title: "How it works",
  ...
  },
  {
    ...
    stage: "Platform",
    summary:
 "One-off agent integrations do not scale. A shared control plane - context, typed actions, approval, and evals - made the next agent a product reuse problem, not a prototype from zero.",
    ...
    blocks: [
      {
        title: "In plain terms",
        body: [
          "Five agents on one pattern beats five bespoke prototypes",
          ...
          "Shared evaluation and QA baselines make “production-ready” a repeatable path, not a one-off review",
        ],
      },
      {
        title: "What I owned",
        body: [
          "Standardized the product and control pattern across five enterprise agent systems",
          "Defined the human-supervised architecture: interfaces, typed actions, HITL gates, and eval baselines",
          "Treated agent development as a reusable product capability rather than a sequence of prototypes",
        ],
      },
      {
        title: "Control model",
  ...
  },
  {
    ...
    stage: "0→1",
    summary:
 "A what-if engine that priced the next trade’s capital cost across venues - before the desk committed. Incremental vs standalone made portfolio offsets visible.",
    ...
    blocks: [
      {
        title: "In plain terms",
        body: [
 "Before you add a trade, you need its capital cost - not after the fill",
 ...
 "“Up to −30%” is observed potential when offsets apply - not a guaranteed savings for every trade",
        ],
      },
      {
        title: "What I owned",
        body: [
          "Originated and shipped the 0→1 what-if product from discovery through launch",
          "Led discovery across trading, treasury, risk, and operations so the engine answered a real pre-trade question",
          "Made incremental vs standalone cost a first-class product concept, not a spreadsheet side path",
        ],
      },
      {
        title: "How it works",
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        body: [
          "I directed product design, ranking rules, and quote honesty end-to-end",
 "Implemented and iterated the live app in Cursor - ownership of decisions and quality stays with me",
          ...
          "Shipped as a working product, not a pitch deck. Adoption claims are not the point of this case",
        ],
      },
      {
        title: "How it works",
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        title: "How it was built",
        body: [
          "I directed the watch window, alert rule, and honesty constraints end-to-end",
 "Implemented and iterated the live app in Cursor - product judgment and quality are mine",
          ...
          "A working launch, not a growth story. The case is about the discipline of the watch",
        ],
      },
      {
        title: "How it works",
  ...
  },
  {
    ...
    stage: "0→1 · live product",
    featured: false,
    productHref: liveProducts.daylight,
    productLabel: "Open Daylight",
    summary:
 "Adaptive display lighting for macOS. Warmth and brightness follow a schedule you set - gradual, offline, and honest when another utility owns the colour table.",
    role: "Product and builder. Designed the schedule model, precedence ladder, certainty reporting, and the menu-bar product that stays out of the way.",
    problem:
      "Most display utilities either fight Night Shift and f.lux silently, claim medical outcomes they cannot prove, or hide what actually changed your screen. I wanted something honest: a schedule that survives time zones and DST, rules that do not discard half the state, and language that admits when macOS did not take the write.",
    decision:
      "Ship a menu-bar app that evaluates the same schedule maths on-device. Resolve warmth and brightness on separate precedence ladders. Distinguish asked, accepted, and confirmed. Notice competing colour-table writers instead of fighting them. Never ask for location, network, or analytics.",
    outcome:
 "A signed macOS app (v1.0.0) with Balanced schedules, app rules, pause/restore, multi-display identity, and a marketing site that runs the same evaluation code. Built end-to-end. Not notarised yet - Gatekeeper needs one honest first-open step, and the site says so.",
    metrics: [
      { value: "Offline", label: "no network, ever" },
      { value: "3 levels", label: "asked · accepted · confirmed" },
      { value: "Menu bar", label: "where it actually lives" },
    ],
    chips: ["Schedule fades", "Explainable state", "Readback certainty", "No location permission"],
    flow: [
      { stage: "Schedule", title: "Through the day", note: "Anchors on the clock. Fades in mired. Survives DST and midnight." },
      { stage: "Explain", title: "Name the cause", note: "Every state has a sentence. Precedence is printed, not implied." },
      { stage: "Confirm", title: "Trust the readback", note: "Success from an API is not evidence. Competition is reported." },
    ],
    blocks: [
      {
        title: "In plain terms",
        body: [
 "Your screen’s warmth and brightness follow a clock schedule - like a quieter Night Shift you control",
          "Asked, accepted, and confirmed are three different facts: the write can succeed in the API and still fail on the display",
          "If another colour-table app wins, Daylight reports it instead of fighting silently",
          "Fully offline: no location, network, or analytics. A signed macOS app; not notarised yet, so Gatekeeper needs one honest first-open step",
        ],
      },
      {
        title: "What I owned",
        body: [
          "Designed the schedule model, separate warmth/brightness precedence ladders, and certainty language end-to-end",
          "Built the menu-bar product and the marketing site that runs the same evaluation code",
          "Chose honesty over medical claims: no melatonin theatre, no invented scores",
        ],
      },
      {
        title: "How it was built",
        body: [
 "Directed product, design, and implementation in Cursor - ownership and quality judgment are mine",
          "Shipped a signed v1.0.0 macOS app with Balanced schedules, app rules, pause/restore, and multi-display identity",
 "A working launch with an honest Gatekeeper caveat - not a growth or notarisation story",
        ],
      },
      {
        title: "Why I built it",
        body: [
          "I wanted display comfort without medical theatre, scores, or melatonin claims",
          "Existing tools either hide failures or overwrite each other quietly. I wanted the opposite",
          "The interesting work was the control model: separate ladders, durable display identity, and honest certainty",
        ],
      },
      {
        title: "How it works",
        body: [
          "Pick a schedule (or build one). Daylight shifts warmth and brightness gradually through the day",
          "App rules and pauses sit above the schedule on a fixed precedence ladder you can see",
          "After every write it reads back; if another utility owns the colour table, it says so",
          "Lives in the menu bar. ⇧⌥⌘R restores normal output. Quitting restores your displays",
        ],
      },
    ],
  },
...
export const principles = [
  {
    ...
    related: [{ slug: "iport", label: "I-Port" }],
  },
  {
    num: "02",
