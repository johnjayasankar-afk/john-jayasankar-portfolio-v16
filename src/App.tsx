...
/** Home + About are eager so recruiting entry points paint identity/experience without a shell. */
...
export default function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/daylight" element={<ProductLaunch href={liveProducts.daylight} label="Daylight" />} />
