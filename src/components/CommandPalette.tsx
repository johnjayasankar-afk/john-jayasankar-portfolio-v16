  ...
  const items = useMemo<CommandItem[]>(() => {
    ...
    return [
      ...
      },
      {
        ...
        group: "Pages",
        keywords: "approach method build control autonomy",
      ...
      },
      {
        ...
        hint: "Live",
        group: "Live",
        keywords: "product app macos display",
        run: () => {
          window.open(liveProducts.daylight, "_blank", "noopener,noreferrer");
        },
      },
      {
        id: "email",
...
function paletteFooter(pathname: string, hash: string): string {
 ...
 : `Approach · 1-5 layers · j/k ladder · y · ${base}`;
  if (pathname === "/simple")
