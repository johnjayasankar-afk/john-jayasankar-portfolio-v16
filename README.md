...
- [Daylight](https://daylight-app-wine.vercel.app/) — adaptive display lighting for macOS

Case studies live on this site at `/work/ridelens`, `/work/raildrop`, and `/work/daylight`. Short paths `/ridelens`, `/raildrop`, and `/daylight` redirect to the live apps.
