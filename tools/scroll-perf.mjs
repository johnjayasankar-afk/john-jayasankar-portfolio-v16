...
//
// Numbers from one run on a busy machine mean very little. Run it twice, back
// to back, with and without a change, and compare those two. That is the only
// comparison this tool is good for, and the only one worth acting on.
//
