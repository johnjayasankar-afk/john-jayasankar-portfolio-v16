#!/usr/bin/env python3
"""Local stand-in for Vercel: cleanUrls, trailingSlash:false, the headers from
vercel.json (so CSP violations show up locally), 404.html with a real 404, and
an optional POST sink for test harnesses.
