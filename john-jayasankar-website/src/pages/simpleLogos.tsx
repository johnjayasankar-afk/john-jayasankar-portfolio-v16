...
function MarginDiagram() {
  return (
    <Frame>
      ...
      <path d="M14 82h128" stroke="currentColor" strokeWidth="1.3" />
      <Cue x="146" y="94" anchor="end">
        −30%
      </Cue>
    </Frame>
  );
...
function RideLensCardArt() {
  return (
    <Frame>
      ...
      <line x1="22" y1="28" x2="70" y2="28" stroke="currentColor" strokeWidth="1.3" opacity="0.5" />
      <circle cx="74" cy="28" r="4" fill="currentColor" />
      <Cue x="18" y="18">
        JFK
      </Cue>
      <Cue x="74" y="18">
      ...
      {[0, 1, 2, 3].map((i) => (
        <g key={i}>
          <rect x="18" y={42 + i * 13} width={110 - i * 16} height="8" fill="currentColor" fillOpacity={i === 0 ? 0.55 : 0.2} />
          {i === 0 && <rect x="14" y={42} width="3" height="8" fill="currentColor" />}
        </g>
      ))}
      <Cue x="138" y="48" anchor="end">
        $
      </Cue>
    </Frame>
  );
...
function RailDropCardArt() {
  ...
  return (
    <Frame>
      ...
      <line x1="118" y1="24" x2="118" y2="84" stroke="currentColor" strokeWidth="1.3" opacity="0.55" />
      <Cue x="118" y="16" anchor="middle">
        $128
      </Cue>
      {prices.map((p, i) => {
        const w = Math.max(8, ((p - 40) / 110) * 70);
        return (
          <g key={p}>
            <rect x="14" y={30 + i * 14} width={w} height="8" fill="currentColor" fillOpacity={i === 0 ? 0.55 : 0.25} />
          </g>
        );
      })}
      <Cue x="146" y="90" anchor="end">
        −$81
      </Cue>
    </Frame>
  );
